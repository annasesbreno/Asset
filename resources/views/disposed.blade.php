...
<div class="container">
  ...
  <div class="">
    ...
    <a class="btn btn-success btn-sm pull-right" href="{{url('disposed-excel')}}" target="_blank"><i class="fa fa-file"></i> Generate Disposed Assets Excel</a>
  </div>
  <br>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <div class="alert alert-success">
              <h4><i class="fa fa-exclamation-circle"></i> No Disposed Devices found.</h4>
            </div>
            @endforelse
          </tbody>
        </table>
