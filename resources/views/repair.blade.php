...
<div class="container">
  ...
  <div class="">
    <a class="btn btn-primary btn-sm" href="{{url('repair/report')}}" target="_blank"><i class="fa fa-print"></i> Generate Asset Under Repair Report</a>
    <a class="btn btn-success btn-sm pull-right" href="{{url('repair-excel')}}" target="_blank"><i class="fa fa-file"></i> Generate Assets Under Repair Excel Report</a>
  </div>
  <br>

    <h2>Hardware Assets Under Repair</h2>
    <div class="row">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <div class="alert alert-success">
              <h4><i class="fa fa-exclamation-circle"></i> No Devices Under Repair found.</h4>
            </div>
            @endforelse
          </tbody>
        </table>
