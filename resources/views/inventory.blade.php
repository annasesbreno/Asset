...
<div class="container">
  ...
  <div class="">
    ...
    <a class="btn btn-success btn-sm pull-right" href="{{url('inventory-excel')}}" target="_blank"><i class="fa fa-print"></i> Generate Inventory Excel</a>
  </div>
  <br>
    ...
    <div class="row">
      <div class="table-responsive">
        ...
        <div class="col-sm-2">
          <select class="pull-right form-control" name="forma" onchange="location = this.value;">
