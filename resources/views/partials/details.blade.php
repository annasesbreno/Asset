  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body long-modal">
        ...
        <h5><b>Deployed By:</b> {{ $employee->hardware->deployed_by->name }}</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#repair{{$hardware->id}}">
            Repair
          </button>
          <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{$hardware->id}}">Dispose</a>
