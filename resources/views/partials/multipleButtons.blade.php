...
<button style="margin-bottom: 10px" class="btn btn-default btn-xs repairAll" data-url="{{ url('repair/all') }}"> <span class="fa fa-wrench"></span> Put all under repair</button>
